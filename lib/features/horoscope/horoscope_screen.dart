    ...
    return signs.when(
      ...
      data: (list) => GridView.builder(
        ...
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: 3, mainAxisSpacing: 12, crossAxisSpacing: 12, childAspectRatio: 0.92,
        ),
        itemCount: list.length,
        itemBuilder: (_, i) {
          final z = list[i];
          return InkWell(
            onTap: () => setState(() => _selected = z['slug']?.toString()),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(z['glyph']?.toString() ?? '☾',
                      style: const TextStyle(fontSize: 28, color: JuntraColors.gold)),
      ...
      data: (h) {
        ...
        return ListView(
          ...
          children: [
            Row(
              children: [
                Text(zodiac['glyph']?.toString() ?? '☾',
                    style: const TextStyle(fontSize: 40, color: JuntraColors.gold)),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(zodiac['date_range']?.toString() ?? '',
